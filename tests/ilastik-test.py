...
if __name__ == '__main__':
    ...
    parser.add_argument('--num_workers_per_computer', type=int, default=2)
    parser.add_argument('--device', type=str, default="gpu")
    parser.add_argument('--num_workers', type=int, default=10)
    parser.add_argument('--max_edge_length', type=int, default=50)
    parser.add_argument('--halo_size', type=int, default=15)
    parser.add_argument('--requests', type=str, default="datasets/sample_req2964.json")
